...
def scrape_url_realtime(url: str, prompt: str) -> str:
    ...
    Args:
        url (str): The complete external URL to be scraped.
        prompt (str): The full, unmodified user question/prompt to guide the summarization.

    Returns:
        str: Tavily's produced answer with the summarized content or insights extracted from the provided URL.
    """
